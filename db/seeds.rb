...
hey_jude = Song.create(title: "Hey Jude", artist_id: the_beatles, genre_id: pop.id, length: 3.03)
yellow_submarine = Song.create(title: "Yellow Submarine", artist_id: the_beatles, genre_id: pop.id, length: 2.48)
back_in_black = Song.create(title: "Back in Black", artist_id: acdc, genre_id: rock.id, length: 4.29)
rocketman = Song.create(title: "Rocketman", artist_id: elton_john, genre_id: pop.id, length: 3.45)
the_chain = Song.create(title: "The Chain", artist_id: fleetwood_mac, genre_id: rock.id, length: 4.17)
born_in_the_usa = Song.create(title: "Born in the USA", artist_id: bruce_springsteen, genre_id: rock.id, length: 4.25)
heroes = Song.create(title: "Heroes", artist_id: david_bowie, genre_id: rock.id, length: 4.40)
house_mix = Song.create(title: "House mix", artist_id: dj_meh, genre_id: house.id, length: 17.17)
titanium = Song.create(title: "Titanium", artist_id: david_guetta, genre_id: dance.id, length: 4.12)
...
#shovel songs into playlists
# User.add_song_to_playlist(name: beatles, song: hey_jude)
# User.add_song_to_playlist(name: beatles, song: yellow_submarine)
# User.add_song_to_playlist(name: gym, song: back_in_black)
# User.add_song_to_playlist(name: gym, song: the_chain)
# User.add_song_to_playlist(name: gym, song: house_mix)
# User.add_song_to_playlist(name: gym, song: titanium)
# User.add_song_to_playlist(name: walk_to_work, song: hello)
# User.add_song_to_playlist(name: walk_to_work, song: rocketman)
# User.add_song_to_playlist(name: walk_to_work, song: heroes)
# User.add_song_to_playlist(name: walk_to_work, song: born_in_the_usa)
# User.add_song_to_playlist(name: massive_tunes, song: rocketman)
# User.add_song_to_playlist(name: massive_tunes, song: heroes)
# User.add_song_to_playlist(name: massive_tunes, song: hello)
# User.add_song_to_playlist(name: massive_tunes, song: back_in_black)
